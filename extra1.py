...
def main():
    ...
    if experiment == 2:
        ...
        for row in final_list:
            ...
            valuesAccelX.append(foo(1, current_row[1]))
            valuesAccelY.append(foo(1, current_row[2]))
            valuesAccelZ.append(foo(1, current_row[3]))
        ...
        np.savetxt("dataoutput/AccelXExp"+ str(experiment) + "Part" + str(participant) + ".txt", valuesAccelX, delimiter=" ")
        np.savetxt("dataoutput/AccelYExp"+ str(experiment) + "Part" + str(participant) + ".txt", valuesAccelY, delimiter=" ")
        np.savetxt("dataoutput/AccelZExp"+ str(experiment) + "Part" + str(participant) + ".txt", valuesAccelZ, delimiter=" ")
